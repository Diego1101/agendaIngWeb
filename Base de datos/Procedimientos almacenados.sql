...
BEGIN
	...
	INSERT INTO MENSAJE VALUES(NULL, MENSAJE, USU,NOW(),1);
	...
	INSERT INTO TEMP 
	SELECT null, USU_CVE FROM USUARIO WHERE USU_ROL=ROL OR USU_CAR=CARRERA OR USU_SEM=SEMESTRE OR USU_GRU=GRUPO;
